...
function validate(task) {
    ...
    for (x = 0; x < length; ++x) {
        ...
        if (curr.description !== undefined) {
            assert(lang.isString(curr.description) || lang.isFunction(curr.description) || curr.description === null, 'Expected subtask description at index \'' + x + '\' to be a string or null in \'' + taskId + '\' task');
        }
