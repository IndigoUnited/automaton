...
var Logger = dejavu.Class.declare({
    ...
    info: function (data, $debug) {
        if (this._checkLevel($debug)) {
            ...
            this._stdout.write(this._padding + data);
        }
    ...
    warn: function (data, $debug) {
        if (this._checkLevel($debug)) {
            data = this._indent(data.toString());
            this._stdout.write((this._padding + data).warning);
        }
    ...
    error: function (data, $debug) {
        if (this._checkLevel($debug)) {
            data = this._indent(data.toString());
            this._stderr.write((this._padding + data).error);
        }
    ...
    success: function (data, $debug) {
        if (this._checkLevel($debug)) {
            data = data.toString();
            this._stdout.write((this._padding + data).success);
        }
