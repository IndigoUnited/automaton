...
var Runner = dejavu.Class.declare({
     ...
     * If the worker is not yet created, it will make it is created before running any task.
     */
    _processQueue: function () {
        // do nothing if no tasks are queued or if a task is beeing run
